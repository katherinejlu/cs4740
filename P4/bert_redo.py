...
def evaluate(args, model, tokenizer, prefix="", test=False):
    ...
    for eval_task, eval_output_dir in zip(eval_task_names, eval_outputs_dirs):
        ...
        output_eval_file = os.path.join(eval_output_dir, "is_test_" + str(test).lower() + "_eval_results.csv")
        ...
        with open(output_eval_file, "w") as writer:
            ...
            for i in range(len(out_label_ids)): 
                ...
                writer.write(str(out_label_ids[i]) + ",")
                writer.write(str(preds[i]) + "\n")
#            writer.write("fp16            =%s\n" % args.fp16)
...
def main():
    ...
    ## Required parameters
    parser.add_argument("--data_dir", default='swag/data', type=str, required=False,
                        help="The input data dir. Should contain the .tsv files (or other data files) for the task.")
    parser.add_argument("--model_type", default='bert', type=str, required=False,
                        help="Model type selected in the list: " + ", ".join(MODEL_CLASSES.keys()))
    parser.add_argument("--model_name_or_path", default='mini', type=str, required=False,
                        help="Path to pre-trained model or shortcut name selected in the list: " + ", ".join(ALL_MODELS))
    parser.add_argument("--task_name", default='swag', type=str, required=False,
    ...
    parser.add_argument("--cache_dir", default="swagcache", type=str,
